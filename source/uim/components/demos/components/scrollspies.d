module uim.components.demos.components.scrollspies;
...
static this() {
	demoUIMComps.pages("components/scrollspies", new class DH5AppPage {
		this() { 
			...
			.parameters([
					"pageTitle": "Scrollspies - uim-components Demo",
          ]);
		} 
...
auto exampleExample = demoUIMExample("example", "Example",
  H5Div(
    UIMNav("navScrollspy", ["nav-pills", "fixed-top"], 
      UIMNavItem(
        UIMNavLink(["href":"#sectionFirst"], "First section")),
      UIMNavItem(
        UIMNavLink(["href":"#sectionSecond"], "Second section")),
      UIMNavItem(
        UIMNavLink(["href":"#sectionThird"], "Third section"))),
          H5Div("sectionFirst", 
            H5H2("First section"),
...
H5Main(
  H5Div(["container-fluid", "mt-3", "bg-light"],
    ...
    ["UI Manufaktur", "Demos", "uim-components", "Components"], "Scrollspies")),
