...
static this() {
	demoUIMComps.pages("basic/components/tooltips", new class DH5AppPage {
		this() { 
			super(); 
			this
			...
			.parameters([
					"pageTitle": "Tooltips - uim-components Demo",
          "script":
...
H5Main("app", ["style":"margin-top:70px;"],
  H5Div(["container-fluid", "mt-3", "bg-light"],
    ...
    ["UI Manufaktur", "Demos", "uim-components" , "Basic", "Components"], "Tooltips")),
