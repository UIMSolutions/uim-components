module uim.components.demos.demos.contents.typography;

import uim.components;

static this() {
	demoUIMComps.pages("basic/contents/typography", new class DH5AppPage {
		this() { 
			super(); 
			this
			...
			.parameters([
					"pageTitle": "Typography - uim-components Demo",
          "script":
...
H5Main("app", ["style":"margin-top:70px;"],
  H5Div(["container-fluid", "mt-3", "bg-light"],
    ...
    ["UI Manufaktur", "Demos", "uim-components" , "Basic", "Contents"], "Typography")),

  BS5Container(["mt-3"]).row(
    H5Div(["col-12", "col-lg-2"], 
      listCompLevels("basic"),    
      listCompAreas("basic", "contents"),    
      listCompSections("basic", "contents", "typography"),    
    ),
