module uim.components.demos.demos.utilities.overflow;

import uim.components;

static this() {
	demoUIMComps.pages("basic/utilities/overflow", new class DH5AppPage {
		this() { 
			super(); 
			this
			...
			.parameters([
					"pageTitle": "Overflow - uim-components Demo",
          "script":
...
H5Main("app", ["style":"margin-top:70px;"],
  H5Div(["container-fluid", "mt-3", "bg-light"],
    ...
    ["UI Manufaktur", "Demos", "uim-components" , "Components", "Utilities"], "Overflow")),

  BS5Container(["mt-3"]).row(
    H5Div(["col-12", "col-lg-2"], 
      listCompLevels("basic"),    
      listCompAreas("basic", "utilities"),    
      listCompSections("basic", "utilities", "overflow"),    
    ),
