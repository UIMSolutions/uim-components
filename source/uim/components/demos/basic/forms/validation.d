module uim.components.demos.demos.forms.validation;

import uim.components;

static this() {
	demoUIMComps.pages("forms/validation", new class DH5AppPage {
		this() { 
			super(); 
			this
...
H5Main("app", ["style":"margin-top:70px;"],
  H5Div(["container-fluid", "mt-3", "bg-light"],
    ...
    ["UI Manufaktur", "Demos", "uim-components" , "Basic", "Forms"], "Validation")),

  BS5Container(["mt-3"]).row(
    H5Div(["col-12", "col-lg-2"], 
      listCompLevels("basic"),    
      listCompAreas("basic", "forms"),    
      listCompSections("basic", "forms", "validation"),    
    ),
